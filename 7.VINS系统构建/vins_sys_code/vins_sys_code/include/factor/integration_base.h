...
/***********************************************************************************************************************
Estimator::IntegrationBase类：函数解释：
    1.IntegrationBase::push_back()每一帧都对应一个预积分
    2.IntegrationBase::propagate()
    3.IntegrationBase::midPointIntegration()计算状态转移矩阵F，雅克比矩阵 jacobian = (F+I)*jacobian，和协方差矩阵
    4.系统位置Ps，速度Vs，旋转Rs通过IMU测量值进行更新
************************************************************************************************************************/
class IntegrationBase
{
  public:
    //https://www.cnblogs.com/Joezzz/p/9705607.html   =delete用法
